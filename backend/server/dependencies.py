from init import (
    get_anime_encoder_instance,
    get_anime_weights_instance,
    get_model_instance,
    get_user_encoder_instance,
    get_user_weights_instance,
    get_df_anime_instance,
    get_df_score_instance,
    get_cosine_sim_sparse_instance,
)
...
def get_content_based_dependencies():
    ...
    return {
        "df_anime": get_df_anime(),
        "cosine_sim": get_cosine_sim_sparse(),
    }
